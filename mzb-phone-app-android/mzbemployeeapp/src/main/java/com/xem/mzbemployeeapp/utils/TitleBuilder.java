...
//		ivMore = (ImageView) viewTitle.findViewById(R.id.titlebar_iv_more);
...
//	//more
//	public TitleBuilder setMoreImage(int resId) {
//		ivMore.setVisibility(resId > 0 ? View.VISIBLE : View.GONE);
