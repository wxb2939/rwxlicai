...
import com.xem.mzbemployeeapp.entity.Plan137detailData;
import com.xem.mzbemployeeapp.net.NetCallBack;
import com.xem.mzbemployeeapp.utils.CompareTime;
...
public class E3_Manager137ModifyAty extends MzbActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TitleBuilder(this).setTitleText("修改137计划").setLeftImage(R.mipmap.top_view_back).setRightText("取消计划").
...
//        params1.put("finished", state.toString());managerState
        if (managerState.getText().toString().equals("已完成")){
