...
import com.xem.mzbemployeeapp.entity.OrderQuery;
import com.xem.mzbemployeeapp.entity.Store;
...
public class E2_OrderQueryAty extends MzbActivity {
    ...
    protected void onResume() {
        super.onResume();
        View grounds = View.inflate(E2_OrderQueryAty.this, R.layout.ground_order_back, null);
    }
