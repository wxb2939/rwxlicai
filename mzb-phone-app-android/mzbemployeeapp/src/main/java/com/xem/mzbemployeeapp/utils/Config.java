...
public class Config {
    ...
    public static final String KEY_FIRST_BRAND = "firstbrand";

    //firstbranid缓存
    public static String getCachedFirstBrandId(Context context) {
        return context.getSharedPreferences(APP_ID, Context.MODE_PRIVATE).getString(KEY_FIRST_BRAND, null);
    }

    public static void cachedFirstBrandId(Context context, String brand) {
        Editor editor = context.getSharedPreferences(APP_ID, Context.MODE_PRIVATE).edit();
        editor.putString(KEY_FIRST_BRAND, brand);
        editor.commit();
    }

    //  门店名称 缓存
    public static String getCachedBrand(Context context) {
        return context.getSharedPreferences(APP_ID, Context.MODE_PRIVATE).getString(KEY_BRAND, null);
    }

    public static void cachedBrand(Context context, String brand) {
        Editor editor = context.getSharedPreferences(APP_ID, Context.MODE_PRIVATE).edit();
    ...
    public static Boolean getCachedIsemploye(Context context) {
        context= MzbApplication.getmContext();
...
//  portrait 性别缓存
    ...
    public static void cachedSex(Context context, String portrait) {
        Editor editor = context.getSharedPreferences(APP_ID, Context.MODE_PRIVATE).edit();
        editor.putString(KEY_SEX, portrait);
        editor.commit();
    }
