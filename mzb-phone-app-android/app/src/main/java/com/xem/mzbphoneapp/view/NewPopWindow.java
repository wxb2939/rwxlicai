...
public class NewPopWindow extends PopupWindow {
    ...
    public View addTaskLayout,teamMemberLayout;

    public NewPopWindow(final Activity context) {
        ...
        addTaskLayout = (LinearLayout) conentView
                .findViewById(R.id.sweep);

        teamMemberLayout = (LinearLayout) conentView
    ...
    public void showPopupWindow(View parent) {
        if (!this.isShowing()) {
            // 以下拉方式显示popupwindow
            this.showAsDropDown(parent, parent.getLayoutParams().width /3, 1);
        } else {
            this.dismiss();
        }
    }
