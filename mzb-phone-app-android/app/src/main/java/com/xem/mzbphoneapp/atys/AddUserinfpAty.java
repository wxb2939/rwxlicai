...
/**
 * Created by xuebing on 15/9/14.
 */
public class AddUserinfpAty extends MzbActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TitleBuilder(this).setTitleText("添加个人说明").setLeftImage(R.mipmap.top_view_back);
